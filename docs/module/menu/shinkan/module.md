...
[Dagger Heart - 匕首之心](#dagger-heat---匕首之心) —— 奇幻世界、轻量共创规则

[DND 5R - 龙与地下城](#dnd-5r---龙与地下城) —— 经典 IP、西方中世纪奇幻

[Pathfinder - 开拓者 1 版](#pathfinder---开拓者-1-版) —— 西方中世纪奇幻、硬核规则
...
贴心建议：`火焰易伤`、`智力`（`调查`/`历史`/`宗教`）、`魅力技能`、善用`惑控法术`
...
贴心建议：`智力`（`历史`）、挖掘不同阵营势力故事、善用功能性/社交类`法术`
...
贴心建议：`黯蚀免疫`、远距离手段、`预言系法术`、“诚实之域”[+诚实之域]
