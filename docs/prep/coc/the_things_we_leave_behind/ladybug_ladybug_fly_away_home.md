...
- **县级体制**——每县一个公共儿童服务局（俄亥俄法律明文），社工是县雇员
  - 流水线：接报 → 调查家访 → 社工签宣誓申请书 → 县律师向少年法庭立案 → 法官签紧急监护令 → 儿童进县立庇护所 → 庭前聆讯
- **社工不能直接带走孩子**——紧急监护令要法官签
- **聆讯可以拖**——县方连续申请延期是常规战术（两年前拖了六周）
- **12/22 时限**——县监护累计满 22 个月中的 12 个月，县必须起诉永久剥夺亲权
- **桌上用法**：
...
- **桌上用法**：
  ...
  - 约翰对调查员说「国家想偷走我们的孩子」时有实底——在他的叙述里这不是比喻，是差一点办成的全家死刑；这句话在书桌上不是疯话是创伤
  - Regina（时年 3 岁）在庇护所住了六周——「家」对这个孩子有一段==不是家的记忆==
...
- **桌上用法**：
  - 教会已烧掉两次预言（约五年前、两年前），信徒没散；两年前落空与儿童保护投诉只差一周（原文明写 not a coincidence）
...
- **克利夫兰**——1950 年峰值 91.5 万人（全美前列）→ 2020 年 37 万；衰败期外号「湖上之错」
