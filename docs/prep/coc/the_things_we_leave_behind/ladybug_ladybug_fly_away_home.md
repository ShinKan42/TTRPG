...
- **寄养系统==——Regina 差点去的地方==**
  ...
  - ==**亲属优先**==——合适亲属不在场才探非亲属；先县庇护所、再转持证寄养家庭
...
- **无宗派教会==——谁也不归的教堂==**
  ...
  - **桌上用法**：
    - **教会两次预言落空**：（约五年前、两年前），信徒没散；
      - **时点咬合**：两年前落空与儿童保护投诉只差一周（原文明写 not a coincidence）
...
- **城市调查群==——五线档案与访谈==**
  ...
  ---
    ...
    - **法庭线**：==密封卷宗「In re R.B.」==，只按姓名缩写索引
      ...
      - **完全没有任何虐童证据**：法官以「」当庭质疑申请动机，威胁再犯就办琳赛藐视法庭
