...
<!-- 招募帖速取：角色塑造问题=Q24-a 两问（2026-09-13 定案，已回填）。复跑出帖直接复制下方代码块改「时间」一行；敏感点两层制=标题行四项+「报名前与主持人确认边界」句，六房间详情私发不进帖。写法标准见 TTRPG/创作准则/通用/招募帖模板.md。线上玩家面：module/coc 选集卡，场地/费用/时间变更两处同步 -->
