...
每篇对应一条龙（绿→金→银→黄铜→青铜→红→黑→白→赤铜→蓝），等级 1~12 递进，可作为独立短团，也可串成长团。
...
| 6 | 🔴 红龙 | 禁忌谷 | The Forbidden Vale | 9 | 待录 |
| 7 | ⚫ 黑龙 | 风暴将临 | Before the Storm | 10 | 待录 |
| 8 | ❄️ 白龙 | 夺命颤寒 | Shivering Death | 11 | 待录 |
