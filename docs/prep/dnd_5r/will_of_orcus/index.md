...
2、欺骗，对角色意味着什么？被善意的谎言骗过，还是被恶意的真话伤过？如果骗局救了人，它还算恶吗？
3、侍奉一个不存在（或已死）的对象是什么感觉？角色有过把信念寄托在错的东西上的经历吗？
---
联系人：
ShinKan42
```
...
| AC | 先攻 | HP | 速度 | CR |
|:---:|:---:|:---:|:---:|:---:|
| 16 | +3 (13) | 97（15d8 + 30） | 30 尺 | 6（2,300 XP） |
...
***恶臭 Stench。*** 体质豁免 DC13：任何在妖鬼周围 5 尺光环内开始其回合的生物都会受影响。失败：目标中毒直到其下回合开始。成功：该生物 24 小时内免疫此妖鬼的恶臭。

**——施法——**

***施法 Spellcasting。*** 妖鬼施放下列法术之一，无需材料成分，以智力为施法属性：

- **随意**：死者交谈、奇术

**——动作——**

***多重攻击 Multiattack。*** 妖鬼发动两次恐怖坏死攻击，可其中一次替换为爪击。

***爪击 Claw。*** 近战攻击命中 +6，触及 5 尺，一个目标。命中：13（3d6 + 3）挥砍伤害。若目标不是不死生物，目标麻痹直到其下回合结束。

***恐怖坏死 Horrific Necrosis。*** 近战或远程攻击命中 +7，触及 5 尺或射程 120 尺，一个目标。命中：15（2d10 + 4）暗蚀伤害，且目标恐慌直到其下回合结束。

::: tip 本桌口径

希娅以此卡登场，作为 4 级团的首领，威胁主要来自麾下尸群——号令群尸才是她的真身，面板单值不足为惧。
...
| 17 | +0 | 45（6d8 + 18） | 30 尺，飞行 60 尺 | 2（450 XP） |
...
***多重攻击 Multiattack。*** 雏龙发动两次撕裂攻击。



***撕裂 Rend。*** 近战攻击命中 +6，触及 5 尺，一个目标。命中：9（1d10 + 4）穿刺伤害。



***寒息 Cold Breath（充能 5-6）。*** 体质豁免 DC13：15 尺锥状区域内每个生物。失败：18（4d8）冷冻伤害。成功：伤害减半。



***麻痹息 Paralyzing Breath。*** 体质豁免 DC13：15 尺锥状区域内每个生物。失败一次：目标失能直到其下回合结束，此时重掷豁免。失败两次：目标麻痹，其每个回合结束时重掷豁免，成功则自行解除。1 分钟后自动成功。

::: tip 本桌口径

语言栏外加通用语，是本个体的特例。4 级团里他打起来很轻，真正的价值在扮演。

:::

::: tip 霜息余威（魔改）

他在 T13 参战期间，本厅寒雾随他苏醒——每轮一次，他的回合结束时以自身为中心 15 尺半径内地面结霜：范围内敌人敏捷豁免 DC13，失败受 1d6 冰霜伤害且所站地面变为困难地形直到他的下回合开始，成功则伤害减半、地面不结霜。这是雏龙巢穴成形的第一次显形，量级是添彩不翻盘。
...
***受训 Training。*** 平民在 DM 选择的一项技能上具有熟练项，使用该技能做属性检定时具有优势。
...
***木棒 Club。*** 近战攻击命中 +2，触及 5 尺，一个目标。命中：2（1d4）钝击伤害。
**——种族备注——**

***原书未载种族特性。*** 原书对欧瑞安不设种族面板（代词 they）；本桌读作人类平民，不加补录特性。


::: tip 本桌口径

原书代词为 they，正文称名优先。扮演面大于数值面——他是全镇唯一的对话轴。
...
***施法 Spellcasting。*** 狂信者以感知施法（法术豁免 DC12，法术攻击 +4）：
...
***灵体武器 Spiritual Weapon（2/日）。*** 狂信者施放灵体武器，施法属性同上。



**——种族特性（龙裔·红）——**

***龙裔出身 Dragonborn。*** 阿基拉是红鳞龙裔：伤害抗性是火焰；喷吐武器（充能 5-6）——30 尺锥形，DC 12 体质豁免，失败受 2d6 火焰伤害，成功减半。长休后恢复使用。

***黑暗视觉 Darkvision。*** 60 尺。

**——动作——**



***契约之刃 Pact Blade。*** 近战攻击命中 +4，触及 5 尺，一个目标。命中：6（1d8 + 2）挥砍伤害，外加 7（2d6）暗蚀伤害。

::: tip 本桌口径

交际面为零——任何影响动作无效，任何情报不出口，死志就是她全部的人格。战术上先派丧尸上前，自己放狂信者法术。
...
***矮人 Dwarf。*** 黑暗视觉 60 尺；矮人韧性是对抗毒素的豁免具有优势，抗毒伤害。
...
目击明显神圣魔法后立即投降（原书明文）。他那两只食人魔丧尸听他指挥，他一投降战斗立刻变成谈判。
...
血量掉到一半即投降（原书明文）；欺瞒或威吓可以套话。三个狂信者里唯一「面板是敌人、行为是中立」的——动手前想想他值不值得留活口。
...
| 11 | +1 | 45（10d8） | 5 尺，飞行 40 尺（悬浮） | 4（1,100 XP） |
...
***虚体视野 Ethereal Sight。*** 幽魂在物质位面时能看见 60 尺内的以太位面。



***虚体移动 Incorporeal Movement。*** 幽魂可以穿过其他生物与物体，如同穿过困难地形。若在物体内结束回合，受 5（1d10）力场伤害。



***以太化 Etherealness。*** 幽魂施放以太化，无需法术成分，以魅力施法。
...
***多重攻击 Multiattack。*** 幽魂发动两次枯萎之触攻击。



***枯萎之触 Withering Touch。*** 近战攻击命中 +5，触及 5 尺，一个目标。命中：19（3d10 + 3）暗蚀伤害。



***恐怖面容 Horrific Visage。*** 感知豁免 DC13：60 尺锥状区域内每个能看见幽魂且非不死生物的生物。失败：10（2d6 + 3）心灵伤害，且目标恐慌直到幽魂下回合开始。成功：该生物 24 小时内免疫此幽魂的恐怖面容。



***附身 Possession（充能 5-6）。*** 魅力豁免 DC13：幽魂可见的 5 尺内一个类人生物（详见原书附身规则）。

::: tip 本桌口径

态度机——冷漠起步，帮她清丧尸则友好，动她收藏则敌对开战。骇人面容等幽魂本能在图书馆里默认收着，被激怒才全开。
