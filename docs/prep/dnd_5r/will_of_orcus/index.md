...
> **霜息余威（魔改）**：他在 T13 参战期间，本厅寒雾随他苏醒——每轮一次，他的回合结束时以自身为中心 15 尺半径内地面结霜：范围内敌人敏捷豁免 DC13，失败受 1d6 冰霜伤害且所站地面变为困难地形直到他的下回合开始，成功则伤害减半、地面不结霜。这是雏龙巢穴成形的第一次显形，量级＝添彩不翻盘。
